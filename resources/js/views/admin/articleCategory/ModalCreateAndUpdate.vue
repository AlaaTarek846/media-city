        ...
        function resetModal() {
            ...
            setTimeout(async () => {
                if (props.type != 'edit') {
                    ...
                    adminApi.get(`dashboard/articleCategory/${id.value}`)
                        .then((res) => {
                            loading.value = true;
                            let l = res.data.data;
        ...
        AddSubmit() {
            ...
            if (this.type !== 'edit') {
                if (!this.v$.$error) {
                    ...
                    this.loading = true;
                    adminApi.post(`dashboard/articleCategory`, formData)
                        .then((res) => {
                            Swal.fire({
                                icon: 'success',
                ...
                adminApi.post(`dashboard/articleCategory/${this.id}`,formData)
                    .then((res) => {
                        Swal.fire({
                            icon: 'success',
