            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadscrumb-contain">
                        <h2>Sony Alpha a7 IV Mirrorless </h2>
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active">Sony Alpha a7 IV Mirrorless </li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="row g-4">
                                        ...
                                        <div class="product-main-2 no-arrow">
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('website/images/veg-3/home/18.jpg')}}" id="img-1"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('website/images/veg-3/home/15.jpg')}}"
                                            ...
                                            <div>
                                                <div class="slider-image">
                                                    <img src="{{asset('website/images/veg-3/home/20.jpg')}}"
                        ...
                        <div class="col-xl-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="right-box-contain">
                                ...
                                <h2 class="name">Sony Alpha a7 IV Mirrorless Digital Camera</h2>
                                <div class="price-rating">
                                    <h3 class="theme-color price">EGP 49.50 <del class="text-content">EGP 58.46</del> <span
                                ...
                                <div class="procuct-contain">
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Corrupti at cum modi illum impedit provident itaque nobis temporibus, repellat officia, nam explicabo amet laudantium vitae.
                                    </p>
                                </div>
                                ...
                                <div class="pickup-box">
                                    ...
                                    <div class="pickup-detail">
                                        <h4 class="text-content">Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit totam molestias aliquam voluptate excepturi repudiandae esse dicta quis dolor officia.</h4>
                                    </div>
                            ...
                            <div class="product-box-3 wow fadeInUp">
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        <span class="span-name">camera</span>
                                        ...
                                        <h5 class="price"><span class="theme-color">EGP 10.25</span> <del>EGP 12.57</del>
                                        </h5>
