                            ...
                            <div class="product-box-3 h-100 wow fadeInUp">
                                ...
                                <div class="product-footer">
                                    <div class="product-detail">
                                        ...
                                        <h5 class="price">
                                            <span class="theme-color"  style="display: flex;margin-right: 10px;"> EGP 12.52   <h6> / Per Month</h6></span>

                                        </h5>

                                        <div class="price-qty mt-10">

                                            <button  title="View" class="buy-button buy-button-2 bofdfds btn btn-cart w-100 ">
                                                <a data-bs-toggle="modal" data-bs-target="#viewfd">
