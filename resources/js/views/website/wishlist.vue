                    ...
                    <div class="product-card rounded-3">
                        ...
                        <div class="position-relative">
                            ...
                            <div class="d-flex flex-column gap-2">
                                <a href="javascript:;" class="btn btn-action"  @click="removeFavorite(product?.id,index)"><i class="bi bi-trash"></i></a>
                            </div>
                            </div>
                            <div class="position-absolute bottom-0 start-0 end-0 m-3 product-cart">
                            <a href="javascript:;" class="btn btn-dark rounded-5 d-flex align-items-center justify-content-center gap-2 py-2" data-bs-toggle="modal" data-bs-target="#QuickViewModal" @click="showModel(product)"><i class="bi bi-basket2"></i><span>{{$t('global.Add to cart')}}</span></a>
                            </div>
                        </div>
                        <div class="">
