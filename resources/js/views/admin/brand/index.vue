...
<!--                                    <th scope="col">{{ $t('global.image') }}</th>-->
                                    ...
                                    <th scope="col" v-if="permission.includes('brand edit') || permission.includes('brand delete')">{{ $t('global.action') }}</th>
                                </tr>
                                </thead>
...
<!--                                    </td>-->
                                    ...
                                    <td>
                                        <div class="hstack gap-2 fs-15">
                                            ...
                                            <a href="#" @click.prevent="deleteData(item.id,index)" v-if="permission.includes('brand delete') && item.can_delete"
